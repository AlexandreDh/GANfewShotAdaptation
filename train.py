...
def setup_training_loop_kwargs(
    ...
    if adaptation is not None and adaptation != "none":
        args.adaptation = adaptation

    if subspace_interval is not None:
    ...
    args.D_kwargs = dnnlib.EasyDict(class_name=D_class, block_kwargs=dnnlib.EasyDict(),
...
@click.option('--kimg_per_tick', help='Override ticks duration', type=float)
